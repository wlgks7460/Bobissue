...
import InquiryFilter from './Form/InquiryFilter';
...
const Inquiry = () => {
  ...
  const fetchProducts = async (filters) => {
    try {
      ...
      const dummy = [
        { id: 1, name: '무선 이어폰', companyName: '삼성', status: '판매중', createdAt: '2024-01-01' },
        { id: 2, name: '게이밍 마우스', companyName: '로지텍', status: '판매완료', createdAt: '2024-01-15' },
        { id: 3, name: '프로틴 바', companyName: '헬스케어', status: '판매중', createdAt: '2024-02-01' },
      ];
      // 에러 발생 시 더미 데이터 사용
      setProducts(dummy);
    }
  ...
  return (
    <div className="p-6">
      ...
      <InquiryFilter onSearch={fetchProducts} />
