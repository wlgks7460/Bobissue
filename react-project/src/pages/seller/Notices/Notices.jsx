...
const Notices = () => {
  ...
  return (
    <div className='p-6 bg-gray-100 min-h-screen'>
      ...
      {/* Category Filter */}
      <div className='mb-6 inline-flex divide-x divide-gray-300 rounded-md overflow-hidden'>
            ...
            <tbody>
              {filteredNotices.map((notice) => (
                <tr key={notice.id} className='border-b hover:bg-gray-50'>
                  ...
                  <td onClick={() => HandleClicknavigate(notice.id)} className='px-4 py-2'>
                    {notice.title}
                  </td>
