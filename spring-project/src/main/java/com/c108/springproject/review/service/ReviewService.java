...
public class ReviewService {
    ...
    // 리뷰 생성
    @Transactional
    public ReviewCreateResDto createReview(ReviewCreateReqDto request, List<MultipartFile> files) {
        // 상품 확인
...
//        review.setUpdatedUser(request.getCreatedUser());
    ...
    // 리뷰 수정
    @Transactional
    public ReviewUpdateResDto updateReview(Long reviewNo, ReviewUpdateReqDto request, List<MultipartFile> files) {
